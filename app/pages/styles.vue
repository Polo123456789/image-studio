    ...
    <div class="mx-auto max-w-7xl">
      ...
      <div v-else class="grid gap-6 xl:grid-cols-[340px_minmax(0,1fr)]">
        ...
        <section class="flex flex-col overflow-hidden rounded-xl border border-border bg-surface">
          ...
          <div v-if="filteredGuides.length" class="max-h-[65vh] flex-1 overflow-y-auto p-2">
            ...
            >
              ...
              <p class="mt-1.5 line-clamp-2 whitespace-pre-wrap text-xs leading-4 text-text-muted">
                {{ guide.content }}
              </p>
            </button>
          </div>
          ...
          <div v-else-if="listSearch && guides.length" class="px-4 py-8 text-center text-sm text-text-muted">
        ...
        <section class="overflow-hidden rounded-xl border border-border bg-surface">
          ...
          <!-- Editor form -->
          <form class="space-y-5 px-5 py-5" @submit.prevent="saveGuide">

...
INSERT INTO `__new_assets` (`id`, `name`, `original_file_name`, `file_path`, `mime_type`, `file_size`, `hash`, `description`, `tags`, `brand_id`, `created_at`, `updated_at`)
SELECT
  `id`,
  `name`,
  `name`,
  ...
  CASE
    ...
    WHEN substr(trim(`tags`), 1, 1) = '[' THEN `tags`
